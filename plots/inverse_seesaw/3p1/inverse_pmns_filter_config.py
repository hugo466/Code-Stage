...
CONFIG_PATH = PROJECT_ROOT / "config" / "presets" / "inverse_pmns_filter_3p1.txt"
DEFAULT_KEPT_POINTS_DIR = PROJECT_ROOT / "data" / "inverse_seesaw" / "3p1" / "inverse_pmns_filter_kept_points_8x8"
